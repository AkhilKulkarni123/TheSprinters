...
<body>
    ...
    <script>
        ...
        function displayBattle(playerChoice, computerChoice, result) {
            battleArea.style.display = 'block';
            
            playerChoiceEmoji.textContent = emojis[playerChoice];
            computerChoiceEmoji.textContent = emojis[computerChoice];
